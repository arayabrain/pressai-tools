...
#define ALTERA_DMA_NUM_DWORDS           2048 // 2048 * DWORDS(4) = 8KB
#define DESC_CTRLLER_BASE               0x0000
#define CTL_STS_BITS                    0x0100
#define TIMEOUT_THRESH                  0xFFFF
#define MAX_NUM_DWORDS                  0x7FFFF //バッファ最大サイズ 2^19 * DWORDS(4) = 2MB
...
#define PRG_MEM_BASE                    0x00000000
#define PRG_MEM_SIZE                    0x10000000
#define IMG_MEM_BASE                    0x10000000
#define IMG_MEM_SIZE                    0x02000000
#define RESIZE_MEM_BASE                 0x20000000
#define RESIZE_MEM_SIZE                 0x02000000
#define DL_SUB_MEM_BASE                 0x30000000
#define DL_SUB_MEM_SIZE                 0x00800000

#define BAR2_PCIEXTREG_FDONE            0x00000000
#define BAR2_PCIEXTREG_INTCR            0x00000004
#define BAR2_PCIEXTREG_TXEND            0x00000008

#define DMA_MAX_BYTE                    0x00100000

//#define BUFFER_SIZE 32*1024*1024 // 32MB
#define BUFFER_SIZE 32 // 32MB
